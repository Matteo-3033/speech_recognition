...
class Recognizer(AudioSource):
    def __init__(self):
        ...
        self.listening = False  # recognizer status
    ...
    def stop_listening(self):
        ...
        If ``listen()`` is currently running, it will stop and return the part of the audio that has been recorded.
    ...
    def recognize_google_cloud(
        ...
        The ``model`` parameter determines which recognition model will be used. Possible values can be found in the `Google Cloud Speech API documentation <https://cloud.google.com/speech-to-text/docs/reference/rest/v1/RecognitionConfig>`__.
        ...
        if preferred_phrases is not None:
            config["speechContexts"] = [speech.SpeechContext(phrases=preferred_phrases)]
        if show_all:
